...
THEN I am presented with a formatted table showing employee data, including employee ids (CHECK), first names (CHECK), last names(CHECK), job titles (CHECK), departments (CHECK), salaries (CHECK), and managers that the employees report to (CHECK) -->
